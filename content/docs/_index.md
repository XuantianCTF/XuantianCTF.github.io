...
| [渗透测试](pentest/) | ⭐⭐⭐⭐ | 综合能力强 | 信息收集、漏洞利用、后渗透 |
...
渗透测试是模拟攻击者行为对目标系统进行安全评估的技术，综合性最强。

**子方向：**
- [信息收集](pentest/recon/) — 子域名、端口扫描、指纹识别、敏感信息泄露
- [漏洞利用](pentest/exploit/) — 命令注入、文件上传、反序列化、SSRF
- [后渗透](pentest/post-exploit/) — 权限提升、横向移动、持久化
...
| 移动 | Frida | 动态 Hook 框架 |
| 渗透 | Nmap | 端口扫描、服务识别 |
| 渗透 | Metasploit | 漏洞利用框架 |
| 渗透 | Cobalt Strike | 红队协作平台 |
...
- [TryHackMe](https://tryhackme.com/) — 引导式渗透测试学习
